    ...
    >
      <svg width="16" height="16" viewBox="0 0 228 205" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_1020_226)">
          ...
          <path d="M121.68 131.836V58.0078C121.68 52.9297 118.359 49.6094 113.379 49.6094C108.691 49.6094 105.371 53.0273 105.371 58.0078V131.836C105.371 136.719 108.691 140.137 113.379 140.137C118.359 140.137 121.68 136.816 121.68 131.836ZM76.6602 103.027H150.488C155.371 103.027 158.789 99.8047 158.789 95.0195C158.789 90.0391 155.469 86.7188 150.488 86.7188H76.6602C71.6797 86.7188 68.2617 90.0391 68.2617 95.0195C68.2617 99.8047 71.6797 103.027 76.6602 103.027Z" fill="currentColor" fillOpacity="0.85"/>
        </g>
        <defs>
