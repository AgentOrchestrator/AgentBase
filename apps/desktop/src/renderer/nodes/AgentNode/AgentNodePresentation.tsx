...
// Status display configuration
  ...
  return (
    <div className="agent-node-wrapper">
      ...
      <div className={`agent-node-view-switcher ${activeView === 'terminal' ? 'terminal-active' : ''}`}>
        <button
          ...
          {activeView === 'overview' ? (
            <svg width="16" height="16" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1020_300)">
                <path d="M199.219 99.6094C199.219 154.492 154.59 199.219 99.6094 199.219C44.7266 199.219 0 154.492 0 99.6094C0 44.6289 44.7266 0 99.6094 0C154.59 0 199.219 44.6289 199.219 99.6094ZM42.1875 133.008C42.1875 137.891 45.9961 141.699 50.7812 141.699C55.6641 141.699 59.4727 137.891 59.4727 133.008C59.4727 128.32 55.5664 124.316 50.7812 124.316C45.9961 124.316 42.1875 128.223 42.1875 133.008ZM75.0977 126.953C71.7773 126.953 69.043 129.688 69.043 133.008C69.043 136.426 71.582 139.16 75.0977 139.16H150.488C154.004 139.16 156.738 136.426 156.738 133.008C156.738 129.59 154.004 126.953 150.488 126.953H75.0977ZM42.1875 99.707C42.1875 104.59 45.9961 108.398 50.7812 108.398C55.5664 108.398 59.4727 104.492 59.4727 99.707C59.4727 94.9219 55.5664 91.0156 50.7812 91.0156C45.9961 91.0156 42.1875 94.8242 42.1875 99.707ZM75.0977 93.6523C71.7773 93.6523 69.043 96.3867 69.043 99.707C69.043 103.027 71.7773 105.859 75.0977 105.859H150.488C154.004 105.859 156.738 103.125 156.738 99.707C156.738 96.2891 154.004 93.6523 150.488 93.6523H75.0977ZM42.1875 66.4062C42.1875 71.1914 45.9961 75.0977 50.7812 75.0977C55.5664 75.0977 59.4727 71.0938 59.4727 66.4062C59.4727 61.5234 55.6641 57.7148 50.7812 57.7148C45.9961 57.7148 42.1875 61.5234 42.1875 66.4062ZM75.0977 60.3516C71.582 60.3516 69.043 62.9883 69.043 66.4062C69.043 69.7266 71.7773 72.5586 75.0977 72.5586H150.488C154.004 72.5586 156.738 69.8242 156.738 66.4062C156.738 62.9883 154.004 60.3516 150.488 60.3516H75.0977Z" fill="currentColor" fillOpacity="0.85"/>
              </g>
              <defs>
          ...
          {activeView === 'terminal' ? (
            <svg width="16" height="16" viewBox="0 0 231 180" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1020_338)">
                <path d="M230.273 30.2734V149.609C230.273 169.727 220.117 179.785 199.609 179.785H30.6641C10.2539 179.785 0 169.727 0 149.609V30.2734C0 10.1562 10.2539 0 30.6641 0H199.609C220.117 0 230.273 10.1562 230.273 30.2734ZM89.5508 80.4688C85.9375 80.4688 83.1055 83.3984 83.1055 87.0117C83.1055 90.625 85.9375 93.5547 89.5508 93.5547H127.93C131.641 93.5547 134.473 90.625 134.473 87.0117C134.473 83.3984 131.641 80.4688 127.93 80.4688H89.5508ZM40.625 46.582L64.8438 61.1328L40.625 75.8789C32.7148 80.5664 39.3555 92.6758 48.1445 87.207L77.0508 69.043C82.8125 65.4297 82.5195 56.8359 77.0508 53.3203L48.1445 35.2539C39.3555 29.7852 32.6172 41.6992 40.625 46.582Z" fill="currentColor" fillOpacity="0.85"/>
              </g>
              <defs>
            ...
            <svg width="16" height="16" viewBox="0 0 231 180" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1020_328)">
                <path d="M30.6641 179.785H199.609C220.117 179.785 230.273 169.727 230.273 149.609V30.2734C230.273 10.1562 220.117 0 199.609 0H30.6641C10.2539 0 0 10.1562 0 30.2734V149.609C0 169.727 10.2539 179.785 30.6641 179.785ZM30.8594 164.062C21.0938 164.062 15.7227 158.887 15.7227 148.73V31.1523C15.7227 20.9961 21.0938 15.7227 30.8594 15.7227H199.414C209.082 15.7227 214.551 20.9961 214.551 31.1523V148.73C214.551 158.887 209.082 164.062 199.414 164.062H30.8594Z" fill="currentColor" fillOpacity="0.85"/>
                <path d="M41.9927 75.4896C34.3755 80.0794 40.8208 91.7005 49.2193 86.4271L77.3443 68.849C82.9107 65.3333 82.6177 57.0325 77.3443 53.7122L49.2193 36.1341C40.8208 30.8607 34.2778 42.3841 41.9927 47.0716L65.5278 61.2318L41.9927 75.4896ZM83.2036 86.3294C83.2036 89.7474 85.938 92.5794 89.4536 92.5794H126.661C130.177 92.5794 132.911 89.7474 132.911 86.3294C132.911 82.8138 130.177 79.9818 126.661 79.9818H89.4536C85.938 79.9818 83.2036 82.8138 83.2036 86.3294Z" fill="currentColor" fillOpacity="0.85"/>
              </g>
              <defs>
        ...
        >
          {activeView === 'chat' ? (
            <svg width="16" height="16" viewBox="0 0 226 204" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_1020_347)">
                <path d="M112.891 187.891C178.418 187.891 225.879 148.34 225.879 93.9453C225.879 39.4531 178.32 0 112.891 0C47.4609 0 0 39.4531 0 93.9453C0 133.105 21.4844 143.652 21.4844 161.133C21.4844 168.75 19.043 173.73 13.1836 179.199C8.78906 183.105 11.1328 187.891 17.5781 187.891C31.0547 187.891 44.8242 183.496 54.8828 176.172C71.7773 183.887 91.4062 187.891 112.891 187.891Z" fill="currentColor" fillOpacity="0.85"/>
              </g>
              <defs>
